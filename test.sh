...
# ./build/bin/fastLEC -i ../ins/miter_error/bit11/miter11o11.aig -m ES -p use_ies 1 -p ies_u64 0 -p es_bv_bits 10 |gnomon
# ./build/bin/fastLEC -i ../ins/miter_error/bit28/miter28o28.aig -m ES -p use_ies 1 -p ies_u64 0 -p es_bv_bits 42 |gnomon
./build/bin/fastLEC -i ../ins/all/test_11_TOP5.aiger -m ES -p use_ies 1 -p ies_u64 0 -p es_bv_bits 14 |gnomon
